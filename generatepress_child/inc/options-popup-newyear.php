            ...
            <div class="popup-field-column">
                ...
                <div class="popup-field">
                    ...
                    <div class="popup-field-auto-close">
                        <input type="number" name="<?php echo $prefix; ?>[auto_close]" value="<?php echo esc_attr($auto_close); ?>" min="0" max="10000">
...
function popup_newyear_shortcode( $atts, $content = null, $tag = '' ) {
        ...
        <div class="popup-new-year-container">
            ...
            <div class="popup-new-year-description">
                <div class="popup-new-year-checkbox">
                    <input type="checkbox" id="hidepopupnewyear" name="hidepopupnewyear" value="true">
                ...
                <?php if ( $auto_close > 0 ) : ?>
                    <div class="popup-new-year-countdown" style="margin-left: auto; color: #fff; font-size: 14px; font-family: 'kanit', sans-serif;">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var cookieName = 'hidepopupnewyear';
            var cookieHidePopupNewYear = getCookie(cookieName);
            var popup = document.querySelector('.popup-new-year');
            var closeBtn = document.querySelector('.popup-new-year-close');
            var checkbox = document.getElementById('hidepopupnewyear');

            if (!cookieHidePopupNewYear && popup) {
            ...
            if (popup) {
                popup.addEventListener('click', function(e) {
                    if (!e.target.closest('.popup-new-year-container')) {
                         popup.classList.remove('is-open');
                    }
                });
            }
