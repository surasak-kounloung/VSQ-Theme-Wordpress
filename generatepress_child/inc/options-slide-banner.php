            ...
            ?>
                <div class="slide-banner-item">
                    <?php if ($url) : ?>
                        ...
                        <?php if ($image_pc_id) : ?>
                            <!-- PC Image -->
                            <div class="slide-banner-image d">
                                <?php echo wp_get_attachment_image($image_pc_id, 'full', false, array('class' => '')); ?>
                            </div>
                        <?php endif; ?>

                        <?php if ($image_mobile_id) : ?>
                            <!-- Mobile Image -->
                            <div class="slide-banner-image m">
...
add_shortcode('slide_banner', 'sb_shortcode');

// Enqueue Frontend Assets for Shortcode
function sb_frontend_assets()
{
    global $post;
